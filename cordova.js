...
exports.load = function(callback) {
    ...
    if (navigator.appVersion.indexOf("MSAppHost/2.0;") !== -1) { //if 2.0 then its windows (windows8.1 or windowsphone8.1) + IE 11
        injectIfNecessary('cordova/plugin_list', pathPrefix + 'cordova_plugins_uapp.js', function () {
